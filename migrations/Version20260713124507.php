 ...
 */
final class Version20260713124507 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE condiment (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, explanation VARCHAR(255) NOT NULL, composition VARCHAR(255) DEFAULT NULL, use VARCHAR(255) NOT NULL, note VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, image_url VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, step VARCHAR(255) NOT NULL, season VARCHAR(255) NOT NULL, time VARCHAR(255) NOT NULL, level VARCHAR(255) NOT NULL, main_category VARCHAR(255) NOT NULL, description CLOB NOT NULL)');
        ...
        $this->addSql('CREATE TABLE shopping_list (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, memo VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, user_id INTEGER NOT NULL, CONSTRAINT FK_3DC1A459A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, email VARCHAR(180) NOT NULL, role VARCHAR(20) NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL)');
